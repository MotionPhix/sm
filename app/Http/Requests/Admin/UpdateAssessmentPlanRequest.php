...
class UpdateAssessmentPlanRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->hasPermission('exams.edit');
    }

    public function rules(): array
    {
        $school = $this->user()->activeSchool;
        $assessmentPlanId = $this->route('assessmentPlan')->id;
